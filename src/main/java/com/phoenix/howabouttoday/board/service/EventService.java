...
public interface EventService {
    ...
    void addEvent(EventFormDTO eventFormDTO, List<MultipartFile> eventImageList) throws Exception; // 게시글 작성
    void editEvent(Long eventNum, EventFormDTO eventFormDTO) throws Exception; // 게시글 수정
